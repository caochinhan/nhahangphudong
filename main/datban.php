                                ...
                                <form>
                                    ...
                                    <div class="col-lg-6">
                                        <select name="coso" placeholder="Chọn cơ sở">
                                            <option>CS1: Số 2, ngõ 69 Chùa Láng</option>
                                            <option>CS2: Số 13 Mai Hắc Đế</option>
                                            <option>CS3: Số 35 Dịch Vọng Hậu</option>
