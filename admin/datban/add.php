            ...
            <div class="container-fluid mt-3">
                <div class="col-lg-12">
                    <div style="width:1190px" class="card">
                        <div class="card-body">
                            <h4 class="card-title">Thêm đặt bàn</h4>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-row">
                                        <!-- <div class="form-group col-md-8"> -->
                                            <label>Cơ sở</label>
                                            <input type="number" name="coso" required class="form-control">
                                        <!-- </div> -->
                                    ...
                                    <button type="submit" class="btn btn-dark">Tạo đặt bàn</button>
                                </form>
                            </div>
                        </div>
                    </div>
