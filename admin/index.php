...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    // 1
    $sql_acc  = "SELECT COUNT(*) as 'count' FROM tbl_admin WHERE 1;";
    $sql_prd  = "SELECT COUNT(*) as 'count' FROM tbl_kho WHERE 1;";
    $sql_bill  = "SELECT SUM(tongtien) as 'count' FROM tbl_hoadon WHERE 1;";
    // $sql_bill_chuathanhtoan  = "SELECT COUNT(*) as 'count' FROM bill WHERE status = 0";
    // $sql_DoanhThu  = "SELECT SUM(total) as 'count' FROM tbl_tongtien";
    $sql_Chart  = "SELECT SUM(tongtien) as 'count' , MONTH(ngay) as 'time' FROM tbl_hoadon group by MONTH(ngay)";
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"><?php echo $bill['count']?>đ </h2>
